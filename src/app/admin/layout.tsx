...
const nav = [
  ...
  ["Content", "/admin/content/blog", FileText],
] as const;
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f5] lg:grid lg:grid-cols-[250px_1fr]">
      <aside className="border-r bg-ink p-6 text-white">
        <Link href="/admin" className="font-display text-2xl font-bold">
          THE STAY
        </Link>
        <p className="mt-1 text-xs text-white/50">OPERATIONS</p>
